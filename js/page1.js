function start_qa_pages(){
	...
	$.ajax({
		type: "POST",  
		url: 'http://13.124.207.154:3000/question/getQuestions',
		data:{
			page: 1,
			pageNumber: 5
		}
...
function start_qa_no_a(){
	...
	$.ajax({
		type: "POST",  
		url: 'http://13.124.207.154:3000/question/getUnsolved',
		data:{
			page: 1,
			pageNumber: 5
		}
...
function start_qa_search(){
	...
	$.ajax({
		type: "POST",  
		url: 'http://13.124.207.154:3000/search/searchQuestion',
		data:{
			keyword: keyword_,
			page: 1,
			pageNumber: 5
...
function goto_inner_qa(id_){
	...
	$.ajax({
		type: "POST",  
		url: 'http://13.124.207.154:3000/question/getQuestionDetail',
		data:{
			questionId: id_
		}
		}).success(function( data, textStatus, jqXHR ){
...
function memeber_qa_add_comment(){
	...
	$.ajax({
		url: 'http://13.124.207.154:3000/question/addComment',
		headers: {
			'userSeq': userSeq
		},
		type: "POST",
...
function delete_question(){
	...
	if(del == true){
		var qid = $('#hidden_id').html();
		$.ajax({
			url: 'http://13.124.207.154:3000/delete/deleteQuestion/',
			headers: {
				'userSeq': userSeq
			},
			type: "PUT",
